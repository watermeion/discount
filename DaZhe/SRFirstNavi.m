...
- (void)viewDidLoad {
    ...
    SRFirstVC *firstVC=[[SRFirstVC alloc]init];
...
//        SROfferARewardMainViewController *third=[[SROfferARewardMainViewController alloc]init];
//        [self pushViewController:third animated:NO];
//    }
    //添加悬赏页面 by  郭玉宝
    if ([self.restorationIdentifier isEqualToString:@"thirdNavi"]) {
       SROfferARewardMainViewController *thirdVC=[[SROfferARewardMainViewController alloc]init];
        [self pushViewController:thirdVC animated:NO];
    }
    if([self.restorationIdentifier isEqualToString:@"forthNavi"]){
        SRForthVC *forthVC=[[SRForthVC alloc]init];
    ...
    [self.navigationBar setBarTintColor:[UIColor colorWithRed:0.97 green:0.31 blue:0.36 alpha:1.0]];
